    ...
    <vue-perfect-scrollbar class="drawer-menu--scroll" :settings="scrollSettings">
      <v-list dense expand>
        <template v-for="(item, i) in menus">
          ...
          >
            ...
            <template v-for="(subItem, i) in item.items">
              ...
              <v-list-group v-if="subItem.items" :key="subItem.name" :group="subItem.group" sub-group="sub-group">
                ...
                <v-list-tile
                  v-for="(grand, i) in subItem.children" :key="i" :to="grand.href? grand.href : null"
                  ripple="ripple"
                >
                  <v-list-tile-content>
              ...
              <!--child item-->
              <v-list-tile
                v-else :key="i" :to="subItem.href? subItem.href : null"
          ...
          <!--top-level link-->
          <v-list-tile
            v-else :to="item.href ? item.href : null" ripple="ripple"
